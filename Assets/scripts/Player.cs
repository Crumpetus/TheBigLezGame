...
public class Player : Actor
{
    ...
    void Shoot(bool reverse)
    {
        ...
        foreach (Transform t in shootTransforms)
        {
            ...
            CameraShake.instance.shakeAmount = 0.35f * gunNess;
    ...
    public override void Movement()
    {
        ...
        if (Mathf.Abs(Input.GetAxis("Vertical")) > deadzone)
        {
            ...
            Move(0, moveSpeed * Time.deltaTime * (Input.GetAxis("Vertical") > 0 ? 1 : -1));
        }
        ...
        if (!backshot)
        {
            ...
            weaponSprite.transform.rotation = Quaternion.Euler(0, 0, z + (transform.localScale.x > 0 ? 0 : 180));
        }
    }
